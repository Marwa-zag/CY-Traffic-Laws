...
// Vérifie si une erreur s'est produite lors de la récupération des utilisateurs
if (!$result) {
...
// Vérifie si une erreur s'est produite lors de la récupération des réservations
